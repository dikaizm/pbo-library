        ...
        <table class="table table-striped table-bordered">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <a href="users?action=view_page&email=<%= user.getEmail() %>" class="btn btn-info btn-sm">Lihat</a>
                <a href="users?action=delete&email=<%= user.getEmail() %>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah Anda yakin ingin menghapus pengguna ini?')">Hapus</a>
              </td>
            </tr>
            <% 
                }
